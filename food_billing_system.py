...
Buttons_F=Frame(ReceiptCal_F,bg='#5e35b1',bd=3)
Buttons_F.pack(side=BOTTOM)

Receipt_F=Frame(ReceiptCal_F,bg='#5e35b1',bd=4)
Receipt_F.pack(side=TOP)

MenuFrame = Frame(root,bg='#5e35b1',bd=10)
MenuFrame.pack(side=LEFT)

Cost_F=Frame(MenuFrame,bg='#5e35b1',bd=4)
Cost_F.pack(side=BOTTOM)

Name_F=Frame(MenuFrame,bg='#5e35b1',bd=4)
Name_F.pack()

Sweets_F=Frame(MenuFrame,bg='#5e35b1',bd=4)
Sweets_F.pack(side=LEFT)

Namkeens_F=Frame(MenuFrame,bg='#5e35b1',bd=4)
Namkeens_F.pack(side=LEFT)

AchaarAndChutneys_F=Frame(MenuFrame,bg='#5e35b1',bd=4)
...
##### RECEIPT #####
lblReceipt=Label(Receipt_F,font=('arial',20,'bold'),text='Receipt',bg='#5e35b1',fg='black')
