...
root.title("Annalakshmi Foodzz!!!")
root.configure(background='#5e35b1')

Tops = Frame(root,bg='#5e35b1',bd=15,pady=0,relief=RIDGE)
Tops.pack(side=TOP)

lblTitle=Label(Tops,font=('arial',30,'bold'),text='Annalakshmi Foodzz!!!',bg='black',fg='cornsilk',justify=CENTER)
lblTitle.grid(row=0)


ReceiptCal_F = Frame(root,bg='#5e35b1',bd=10)
ReceiptCal_F.pack(side=RIGHT)

Buttons_F=Frame(ReceiptCal_F,bg='#5e35b1',bd=3,relief=RIDGE)
Buttons_F.pack(side=BOTTOM)

Receipt_F=Frame(ReceiptCal_F,bg='#5e35b1',bd=4,relief=RIDGE)
Receipt_F.pack(side=TOP)

MenuFrame = Frame(root,bg='#5e35b1',bd=10)
MenuFrame.pack(side=LEFT)

Cost_F=Frame(MenuFrame,bg='#5e35b1',bd=4,relief=RIDGE)
Cost_F.pack(side=BOTTOM)

Name_F=Frame(MenuFrame,bg='#5e35b1',bd=4,relief=RIDGE)
Name_F.pack()

Sweets_F=Frame(MenuFrame,bg='#5e35b1',bd=4,relief=RIDGE)
Sweets_F.pack(side=LEFT)

Namkeens_F=Frame(MenuFrame,bg='#5e35b1',bd=4,relief=RIDGE)
Namkeens_F.pack(side=LEFT)

AchaarAndChutneys_F=Frame(MenuFrame,bg='#5e35b1',bd=4,relief=RIDGE)
...
##### NAME #####
lblName = Label(Name_F,font=('arial',12,'bold'),text='Customer Name',bg='#5e35b1',bd=7,fg='black',justify=CENTER)
...
##### SWEETS #####
GondKeLadduInDesiGhee = Checkbutton(Sweets_F,text='Gond Ke Laddu In Desi Ghee',variable=var1,onvalue=1,offvalue=0,font=('arial',10,'bold'),bg='#5e35b1',command=chkGondKeLadduInDesiGhee).grid(row=0,sticky=W)
MethiKeLadduInDesiGhee = Checkbutton(Sweets_F,text='Methi Ke Laddu In Desi Ghee',variable=var2,onvalue=1,offvalue=0,font=('arial',10,'bold'),bg='#5e35b1',command=chkMethiKeLadduInDesiGhee).grid(row=1,sticky=W)
BesanKeLadduInDesiGhee = Checkbutton(Sweets_F,text='Besan Ke Laddu In Desi Ghee',variable=var3,onvalue=1,offvalue=0,font=('arial',10,'bold'),bg='#5e35b1',command=chkBesanKeLadduInDesiGhee).grid(row=2,sticky=W)
BesanKeModakInDesiGhee = Checkbutton(Sweets_F,text='Besan Ke Modak In Desi Ghee',variable=var4,onvalue=1,offvalue=0,font=('arial',10,'bold'),bg='#5e35b1',command=chkBesanKeModakInDesiGhee).grid(row=3,sticky=W)
TilKeLadduInDesiGhee = Checkbutton(Sweets_F,text='Til Ke Laddu In Desi Ghee',variable=var5,onvalue=1,offvalue=0,font=('arial',10,'bold'),bg='#5e35b1',command=chkTilKeLadduInDesiGhee).grid(row=4,sticky=W)
ShakkarParaInDesiGhee = Checkbutton(Sweets_F,text='Shakkar Para In Desi Ghee',variable=var6,onvalue=1,offvalue=0,font=('arial',10,'bold'),bg='#5e35b1',command=chkShakkarParaInDesiGhee).grid(row=5,sticky=W)
GudParaInDesiGhee = Checkbutton(Sweets_F,text='Gud Para In Desi Ghee',variable=var7,onvalue=1,offvalue=0,font=('arial',10,'bold'),bg='#5e35b1',command=chkGudParaInDesiGhee).grid(row=6,sticky=W)
MithiMathriInDesiGhee = Checkbutton(Sweets_F,text='Mithi Mathri In Desi Ghee',variable=var8,onvalue=1,offvalue=0,font=('arial',10,'bold'),bg='#5e35b1',command=chkMithiMathriInDesiGhee).grid(row=7,sticky=W)
GunjiyaInDesiGhee = Checkbutton(Sweets_F,text='Gunjiya In Desi Ghee',variable=var9,onvalue=1,offvalue=0,font=('arial',10,'bold'),bg='#5e35b1',command=chkGunjiyaInDesiGhee).grid(row=8,sticky=W)
GunjiyaInDesiGheeWithoutChasniCoat = Checkbutton(Sweets_F,text='Gunjiya In Desi Ghee Without Chasni Coat',variable=var10,onvalue=1,offvalue=0,font=('arial',10,'bold'),bg='#5e35b1',command=chkGunjiyaInDesiGheeWithoutChasniCoat).grid(row=9,sticky=W)
MisriMawa = Checkbutton(Sweets_F,text='Misri Mawa',variable=var11,onvalue=1,offvalue=0,font=('arial',10,'bold'),bg='#5e35b1',command=chkMisriMawa).grid(row=10,sticky=W)
TilMawaLadduBarfi = Checkbutton(Sweets_F,text='Til Mawa Laddu/Barfi',variable=var12,onvalue=1,offvalue=0,font=('arial',10,'bold'),bg='#5e35b1',command=chkTilMawaLadduBarfi).grid(row=11,sticky=W)
GajjarKaHalwaInDesiGhee = Checkbutton(Sweets_F,text='Gajjar Ka Halwa In Desi Ghee',variable=var13,onvalue=1,offvalue=0,font=('arial',10,'bold'),bg='#5e35b1',command=chkGajjarKaHalwaInDesiGhee).grid(row=12,sticky=W)
BikaneriGondPakInDesiGhee = Checkbutton(Sweets_F,text='Bikaneri Gond Pak In Desi Ghee',variable=var14,onvalue=1,offvalue=0,font=('arial',10,'bold'),bg='#5e35b1',command=chkBikaneriGondPakInDesiGhee).grid(row=13,sticky=W)
ShakkarParaInRefinedOil = Checkbutton(Sweets_F,text='Shakkar Para In Refined Oil',variable=var15,onvalue=1,offvalue=0,font=('arial',10,'bold'),bg='#5e35b1',command=chkShakkarParaInRefinedOil).grid(row=14,sticky=W)
...
##### NAMKEENS #####
SangeetaSpecialBesanKiKachori = Checkbutton(Namkeens_F,text='Sangeeta Special Besan Ki Kachori',variable=var18,onvalue=1,offvalue=0,font=('arial',10,'bold'),bg='#5e35b1',command=chkSangeetaSpecialBesanKiKachori).grid(row=0,sticky=W)
MoongDalKiKachori = Checkbutton(Namkeens_F,text='Moong Dal Ki Kachori',variable=var19,onvalue=1,offvalue=0,font=('arial',10,'bold'),bg='#5e35b1',command=chkMoongDalKiKachori).grid(row=1,sticky=W)
Mathri = Checkbutton(Namkeens_F,text='Mathri',variable=var20,onvalue=1,offvalue=0,font=('arial',10,'bold'),bg='#5e35b1',command=chkMathri).grid(row=2,sticky=W)
AttaMathri = Checkbutton(Namkeens_F,text='Atta Mathri',variable=var21,onvalue=1,offvalue=0,font=('arial',10,'bold'),bg='#5e35b1',command=chkAttaMathri).grid(row=3,sticky=W)
MethiMathri = Checkbutton(Namkeens_F,text='Methi Mathri',variable=var22,onvalue=1,offvalue=0,font=('arial',10,'bold'),bg='#5e35b1',command=chkMethiMathri).grid(row=4,sticky=W)
AttaMethiMathri = Checkbutton(Namkeens_F,text='Atta Methi Mathri',variable=var23,onvalue=1,offvalue=0,font=('arial',10,'bold'),bg='#5e35b1',command=chkAttaMethiMathri).grid(row=5,sticky=W)
BinaMirchKiChakli = Checkbutton(Namkeens_F,text='Bina Mirch Ki Chakli',variable=var24,onvalue=1,offvalue=0,font=('arial',10,'bold'),bg='#5e35b1',command=chkBinaMirchKiChakli).grid(row=6,sticky=W)
MasalaChakli = Checkbutton(Namkeens_F,text='Masala Chakli',variable=var25,onvalue=1,offvalue=0,font=('arial',10,'bold'),bg='#5e35b1',command=chkMasalaChakli).grid(row=7,sticky=W)
PapdiForChaat = Checkbutton(Namkeens_F,text='Papdi For Chaat',variable=var26,onvalue=1,offvalue=0,font=('arial',10,'bold'),bg='#5e35b1',command=chkPapdiForChaat).grid(row=8,sticky=W)
NamkeenPara = Checkbutton(Namkeens_F,text='Namkeen Para',variable=var27,onvalue=1,offvalue=0,font=('arial',10,'bold'),bg='#5e35b1',command=chkNamkeenPara).grid(row=9,sticky=W)
AttaNamkeenPara = Checkbutton(Namkeens_F,text='Atta Namkeen Para',variable=var28,onvalue=1,offvalue=0,font=('arial',10,'bold'),bg='#5e35b1',command=chkAttaNamkeenPara).grid(row=10,sticky=W)
MasalaNamkeenPara = Checkbutton(Namkeens_F,text='Masala Namkeen Para',variable=var29,onvalue=1,offvalue=0,font=('arial',10,'bold'),bg='#5e35b1',command=chkMasalaNamkeenPara).grid(row=11,sticky=W)
NamkeenSankhiye = Checkbutton(Namkeens_F,text='Namkeen Sankhiye',variable=var30,onvalue=1,offvalue=0,font=('arial',10,'bold'),bg='#5e35b1',command=chkNamkeenSankhiye).grid(row=12,sticky=W)
RoastedChirwa = Checkbutton(Namkeens_F,text='Roasted Chirwa',variable=var31,onvalue=1,offvalue=0,font=('arial',10,'bold'),bg='#5e35b1',command=chkRoastedChirwa).grid(row=13,sticky=W)
...
##### ACHAAR AND CHUTNEY'S #####
ChanneKaAchaar = Checkbutton(AchaarAndChutneys_F,text='Channe Ka Achaar',variable=var49,onvalue=1,offvalue=0,font=('arial',10,'bold'),bg='#5e35b1',command=chkChanneKaAchaar).grid(row=0,sticky=W)
GobhiGajjarKaAchaar = Checkbutton(AchaarAndChutneys_F,text='Gobhi Gajjar Ka Achaar',variable=var50,onvalue=1,offvalue=0,font=('arial',10,'bold'),bg='#5e35b1',command=chkGobhiGajjarKaAchaar).grid(row=1,sticky=W)
HeengAamKaAchaar = Checkbutton(AchaarAndChutneys_F,text='Heeng Aam Ka Achaar',variable=var51,onvalue=1,offvalue=0,font=('arial',10,'bold'),bg='#5e35b1',command=chkHeengAamKaAchaar).grid(row=2,sticky=W)
LasodaKaAchaar = Checkbutton(AchaarAndChutneys_F,text='Lasoda Ka Achaar',variable=var52,onvalue=1,offvalue=0,font=('arial',10,'bold'),bg='#5e35b1',command=chkLasodaKaAchaar).grid(row=3,sticky=W)
AamKaAchaar = Checkbutton(AchaarAndChutneys_F,text='Aam Ka Achaar',variable=var53,onvalue=1,offvalue=0,font=('arial',10,'bold'),bg='#5e35b1',command=chkAamKaAchaar).grid(row=4,sticky=W)
MirchNimbuKaAchaar = Checkbutton(AchaarAndChutneys_F,text='Mirch Nimbu Ka Achaar',variable=var54,onvalue=1,offvalue=0,font=('arial',10,'bold'),bg='#5e35b1',command=chkMirchNimbuKaAchaar).grid(row=5,sticky=W)
MeethaNimbuKaAchaar = Checkbutton(AchaarAndChutneys_F,text='Meetha Nimbu Ka Achaar',variable=var55,onvalue=1,offvalue=0,font=('arial',10,'bold'),bg='#5e35b1',command=chkMeethaNimbuKaAchaar).grid(row=6,sticky=W)
AmchoorKiChatni = Checkbutton(AchaarAndChutneys_F,text='Amchoor Ki Chatni',variable=var57,onvalue=1,offvalue=0,font=('arial',10,'bold'),bg='#5e35b1',command=chkAmchoorKiChatni).grid(row=8,sticky=W)
DhaniyeKiChatni = Checkbutton(AchaarAndChutneys_F,text='Dhaniye Ki Chatni',variable=var58,onvalue=1,offvalue=0,font=('arial',10,'bold'),bg='#5e35b1',command=chkDhaniyeKiChatni).grid(row=9,sticky=W)
ImliKiChatni = Checkbutton(AchaarAndChutneys_F,text='Imli Ki Chatni',variable=var59,onvalue=1,offvalue=0,font=('arial',10,'bold'),bg='#5e35b1',command=chkImliKiChatni).grid(row=10,sticky=W)
LehsunKiChatni = Checkbutton(AchaarAndChutneys_F,text='Lehsun Ki Chatni',variable=var60,onvalue=1,offvalue=0,font=('arial',10,'bold'),bg='#5e35b1',command=chkLehsunKiChatni).grid(row=11,sticky=W)
NariyalKiChatni = Checkbutton(AchaarAndChutneys_F,text='Nariyal Ki Chatni',variable=var62,onvalue=1,offvalue=0,font=('arial',10,'bold'),bg='#5e35b1',command=chkNariyalKiChatni).grid(row=13,sticky=W)
PodinaKiChatni = Checkbutton(AchaarAndChutneys_F,text='Podina Ki Chatni',variable=var63,onvalue=1,offvalue=0,font=('arial',10,'bold'),bg='#5e35b1',command=chkPodinaKiChatni).grid(row=14,sticky=W)
TangyMayoCheeseDip = Checkbutton(AchaarAndChutneys_F,text='Tangy Mayo Cheese Dip',variable=var64,onvalue=1,offvalue=0,font=('arial',10,'bold'),bg='#5e35b1',command=chkTangyMayoCheeseDip).grid(row=15,sticky=W)
...
##### Total Cost #####
lblTotalCost = Label(Cost_F,font=('arial',14,'bold'),text='\tTotal',bg='#5e35b1',bd=7,fg='black',justify=CENTER)
...
##### BUTTONS #####
btnTotal = Button(Buttons_F,padx=10,pady=1,bd=7,fg='black',font=('arial',16,'bold'),width=4,text='Total',bg='#5e35b1',command=CostOfItem).grid(row=0,column=0)
btnReceipt = Button(Buttons_F,padx=10,pady=1,bd=7,fg='black',font=('arial',16,'bold'),width=4,text='Receipt',bg='#5e35b1',command=Receipt).grid(row=0,column=1)
btnReset = Button(Buttons_F,padx=10,pady=1,bd=7,fg='black',font=('arial',16,'bold'),width=4,text='Reset',bg='#5e35b1',command=Reset).grid(row=0,column=2)
